...
class BluetoothWithoutServices extends StatefulWidget {
  String? tableName;
  String? branchId;

  BluetoothWithoutServices({super.key, this.branchId, this.tableName});

  @override
  // ignore: library_private_types_in_public_api
  _BluetoothWithoutServicesState createState() =>
      _BluetoothWithoutServicesState();
}

class _BluetoothWithoutServicesState extends State<BluetoothWithoutServices>

...
class _CartScreenState extends State<CartScreen> {
  ...
  sendOrder() async {
    ...
    print("Subtotal before sending order: $subtotal");
    print("Tax before sending order: $tax");
    print("Service Charges before sending order: $serviceCharges");
    print("Total before sending order: $total");
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode <= 400) {
        ...
        print('The body is :${jsonEncode(body)},');
  ...
  Widget build(BuildContext context) {
    ...
    tax = subtotal != null ? (taxRate / 100) * subtotal! : 0.0;
    serviceCharges = subtotal != null ? (serviceRate / 100) * subtotal! : 0.0;
    total = (subtotal ?? 0.0) + (tax ?? 0.0) + (serviceCharges ?? 0.0);
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "Rs. ${serviceCharges.toStringAsFixed(2)}",
                              style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.w400,
                                color: isDarkMode ? Colors.white : Colors.black,
